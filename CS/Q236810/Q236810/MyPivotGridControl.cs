...
namespace DXSample {
    ...
    public class MyFieldCustomizationTreeBox : FieldCustomizationTreeBox {
        ...
        protected override PivotCustomizationTreeNodeViewInfo CreateItemViewInfo(PivotCustomizationTreeNode node) {
            ...
            else return new PivotCustomizationTreeNodeViewInfoListItem(node, (PivotGridViewInfo)Data.ViewInfo);
        }
    }
    ...
    public class MyPivotCustomizationFieldsTree : PivotCustomizationFieldsTree {
        ...
        protected override List<PivotCustomizationTreeNode> PopulateFields(IEnumerable fields) {
            List<PivotCustomizationTreeNode> result = new List<PivotCustomizationTreeNode>();
