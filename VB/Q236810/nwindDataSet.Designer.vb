...
Namespace Q236810
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal Quantity As Short, ByVal Discount As Single, ByVal Sales_Person As String) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { Country, ProductName, CategoryName, Quantity, Discount, Sales_Person}
	...
	End Class
End Namespace
Namespace Q236810.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT Country, ProductName, CategoryName, Quantity, Discount, [Sales Person] FRO" & "M SalesPerson"
